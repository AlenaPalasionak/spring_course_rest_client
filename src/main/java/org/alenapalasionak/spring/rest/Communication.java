...
public class Communication {//с его помощью будем общаться с rest сервисом: запросы - ответы
    ...
    final String URL = "http://localhost:8080/spring_course_rest/api/employees";
    ...
    public Employee getEmployee(int id){
        Employee employee = restTemplate.getForObject(URL +"/" +id, Employee.class);// первый - ссылка, второй-что ожидаем получить,
        return employee;
    }
